...
PigeonWorm::PigeonWorm() : Pigeon(7, 3, 0.15f, 0.85f, 86.5f),
...
Spingeon::Spingeon() : Pigeon(8, 4, 0.90f, 0.10f, 190.0f),
...
Cheerlegeon::Cheerlegeon() : Pigeon(9, 4, 0.65f, 0.35f, 415.0f),
...
Chickenigeon::Chickenigeon() : Pigeon(10, 4, 0.15f, 0.85f, 865.0f),
...
Twingeon::Twingeon() : Pigeon(11, 5, 0.90f, 0.10f, 1900.0f),
...
Pidgeknowledge::Pidgeknowledge() : Pigeon(12, 5, 0.65f, 0.35f, 4150.0f),
...
Pidgeeyes::Pidgeeyes() : Pigeon(13, 5, 0.15f, 0.85f, 8650.0f),
